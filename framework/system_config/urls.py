...
urlpatterns = patterns(
    ...
    (r'^scene_type_html$', 'scene_type_html'),  # 场景类别配置首页
    (r'^crawl_content_html', 'crawl_content_html'),  # 爬虫内容页面
    ...
    (r'^get_crawl_content/$', 'get_crawl_content'),  # 获取爬虫内容
