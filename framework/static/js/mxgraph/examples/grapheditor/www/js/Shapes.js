...
(function()
{
	...
	mxUtils.extend(ReduceShape, mxRectangleShape);
	ReduceShape.prototype.isHtmlAllowed = function()
	{
		return false;
	};
	ReduceShape.prototype.paintForeground = function(c, x, y, w, h)
	{
		var border = Math.min(w / 5, h / 5) + 1;
	...
	mxCellRenderer.registerShape('reduce', ReduceShape);
