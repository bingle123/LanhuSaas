...
Sidebar.prototype.addBasePalette = function(expand)
{
	...
	var fns = [
	 			this.addEntry('基本监控项', function()
	 			{
	 				...
	 				cell.vertex = true;
	 				var cloneObj = sb.cloneCell(field);
	 				cloneObj.value='指标2';
	 				cell.insert(cloneObj);
	 				return sb.createVertexTemplateFromCells([cell], cell.geometry.width, cell.geometry.height, '监控项');
	 			}),
	 			this.addEntry('基本监控项1', function()
	 		 			{
	 		 				var cell = new mxCell('指标1', new mxGeometry(0, 0, 140, 110),
	 		 			    	'swimlane;fontStyle=0;childLayout=stackLayout;horizontal=1;startSize=56;fillColor=none;horizontalStack=0;' +
	 		 			    	'resizeParent=1;resizeParentMax=0;resizeLast=0;collapsible=0;marginBottom=0;');
	 		 				...
	 		 				var cloneObj = sb.cloneCell(field);
	 		 				cloneObj.value='指标2';
	 		 				var cloneObj1 = sb.cloneCell(field);
	 		 				cloneObj1.value='指标3';
	 		 				cell.insert(cloneObj);
	...
	this.addPaletteFunctions('基本监控项', '基本监控项', (expand != null) ? expand : true, fns);
};
/**
 * Adds the general palette to the sidebar.
 */
